                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <textarea
                                                ...
                                                name="about"
                                                //rows="3" 
                                                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="you@example.com"></textarea>
                                        </div>
                                ...
                                <div className="px-4 py-5 bg-white sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6">
                                            <label
                                                //for="street-address" 
                                                className="block text-sm font-medium text-gray-700">Street address</label>
                                        ...
                                        <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label
                                                //for="region" 
                                                className="block text-sm font-medium text-gray-700">State / Province</label>
                                        ...
                                        <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label
                                                //for="postal-code" 
                                                className="block text-sm font-medium text-gray-700">ZIP / Postal code</label>
                                            <input type="text"
                                                name="postal-code"
                                                id="postal-code"
                                ...
                                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <div className="mt-4 space-y-4">
                                            ...
                                            <div className="flex items-center">
                                                <input
                                                    id="push-nothing" name="push-notifications" type="radio" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" />
                                                <label
                                                    //for="push-nothing"
                                                    className="ml-3 block text-sm font-medium text-gray-700">
